...
*   **Управление Друзьями:**
    *   Отправка и принятие/отклонение запросов в друзья
    *   Просмотр списка друзей с их онлайн-статусами и текущими играми
    *   Блокировка и разблокировка пользователей
    *   Удаление из списка друзей
    *   **Предложения друзей:** Рекомендации на основе общих игр, групп или друзей второго порядка
        *   Алгоритм рекомендаций учитывает:
            *   Общие игры в библиотеке (вес: 40%)
            *   Общие группы (вес: 30%)
            *   Друзья друзей (вес: 20%)
            *   Общие жанры игр (вес: 10%)
        *   Максимум 20 предложений, обновляются раз в сутки
        *   Исключаются заблокированные пользователи и те, кому уже отправлен запрос
...
*   **Обмен Сообщениями (Чаты):**
    ...
    *   **Поддержка медиа-контента в чатах (Phase 3):**
        *   Изображения: JPEG, PNG, WebP до 10MB
        *   GIF анимации до 15MB
        *   Файлы: документы до 20MB
        *   Предпросмотр изображений и ссылок
    *   Отображение статусов доставки и прочтения сообщений
    *   **История чатов:**
        *   Хранение последних 10,000 сообщений на сервере
        *   Поиск по истории за последние 90 дней
        *   Архивирование старых сообщений в холодное хранилище
