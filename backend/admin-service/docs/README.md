...
*   [TODO: Добавить диаграмму верхнеуровневой архитектуры Admin Service]
...
*   **`PUT /platform-users/{user_id}/roles`**
    ...
    *   Требуемые права доступа: `admin`.
*   [TODO: Добавить эндпоинты для просмотра истории действий пользователя, сессий и т.д.]
...
*   **`POST /moderation/items/{item_id}/decisions`**
    ...
    *   Требуемые права доступа: `moderator`, `admin`.
*   [TODO: Добавить эндпоинты для управления правилами модерации, просмотра истории модерации].
...
*   [TODO: Добавить эндпоинты для управления категориями тикетов, назначения ответственных, шаблонов ответов].
...
*   **`PUT /platform-settings`**
    ...
    *   Требуемые права доступа: `admin`.
*   [TODO: Детализировать структуру настроек и возможные группы настроек].
...
*   **`POST /admin-users`**
    ...
    *   Требуемые права доступа: `admin` (супер-администратор).
*   [TODO: Эндпоинты для управления ролями и правами администраторов].

### 3.2. gRPC API
*   [TODO: Определить, нужны ли gRPC эндпоинты для Admin Service, и если да, то какие. Возможно, для взаимодействия с другими бэкенд-инструментами или для подписки на определенные события администрирования.]

### 3.3. WebSocket API (если применимо)
*   [TODO: Определить, нужен ли WebSocket API, например, для real-time дашбордов модерации или поддержки.]
...
*   [TODO: Детализировать поля для каждой сущности]
...
*   [TODO: Добавить Mermaid ERD и более детальные DDL]
...
*   [TODO: Добавить другие релевантные события]
...
### 6.2. Внешние Системы
*   [TODO: Определить, если Admin Service будет напрямую интегрироваться с какими-либо внешними системами, например, анти-чит системы, системы анализа изображений/текста для пре-модерации.]
...
*   [TODO: Детальные JSON схемы для API, примеры конфигураций правил модерации и т.д.]
